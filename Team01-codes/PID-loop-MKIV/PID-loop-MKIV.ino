...
//Object declarations
PID motor_A(&motor_A_freq_input, &motor_A_freq_output, &motor_freq_set, KpA, KiA, KdA, DIRECT);
PID motor_B(&motor_B_freq_input, &motor_B_freq_output, &motor_freq_set, KpA, KiA, KdA, DIRECT);
